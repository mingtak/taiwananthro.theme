...
class FolderView(BrowserView):
    ...
    def format_category(self, category):
        if category == 'institute_news':
            return '學會新聞'
        elif category == 'anthropology_news':
            return '人類學界相關新聞'
        elif category == 'event':
            return '活動'
            ...
            return '獎助學金'
        elif category == 'recruitment_notice':
            return '徵人啟事'
        elif category == 'anthropology_category':
            return '人類學相關學術刊物當期目錄'
        elif category == 'anthropology_plan':
            return '國科會通過之人類學門計畫等'
